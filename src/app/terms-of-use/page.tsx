      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-8">
          <div className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-fortress-ivory mb-4">Website Terms of Use</h1>
        ...
        <div className="max-w-[860px] mx-auto px-6 lg:px-8">
          <div className="space-y-10 text-fortress-silver leading-relaxed text-sm sm:text-base">
            ...
            <div className="border-t border-fortress-gold/10 pt-8">
              <h2 className="text-xl font-bold text-fortress-ivory mb-4">Website Purpose</h2>
              <p>
            ...
            <div className="border-t border-fortress-gold/10 pt-8">
              <h2 className="text-xl font-bold text-fortress-ivory mb-4">Information Accuracy</h2>
              <p>
            ...
            <div className="border-t border-fortress-gold/10 pt-8">
              <h2 className="text-xl font-bold text-fortress-ivory mb-4">No Professional Advice</h2>
              <p>
            ...
            <div className="border-t border-fortress-gold/10 pt-8">
              <h2 className="text-xl font-bold text-fortress-ivory mb-4">Opportunity Submissions</h2>
              <p>
            ...
            <div className="border-t border-fortress-gold/10 pt-8">
              <h2 className="text-xl font-bold text-fortress-ivory mb-4">Intellectual Property</h2>
              <p>
            ...
            <div className="border-t border-fortress-gold/10 pt-8">
              <h2 className="text-xl font-bold text-fortress-ivory mb-4">Third-Party Links</h2>
              <p>
            ...
            <div className="border-t border-fortress-gold/10 pt-8">
              <h2 className="text-xl font-bold text-fortress-ivory mb-4">Limitation of Liability</h2>
              <p>
            ...
            <div className="border-t border-fortress-gold/10 pt-8">
              <h2 className="text-xl font-bold text-fortress-ivory mb-4">Governing Law</h2>
              <p>
